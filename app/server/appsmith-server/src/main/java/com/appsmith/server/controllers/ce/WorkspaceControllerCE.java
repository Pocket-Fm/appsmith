...
public class WorkspaceControllerCE {
    ...
    @JsonView(Views.Public.class)
    @GetMapping("/{workspaceId}/is-member")
    public Mono<ResponseDTO<Boolean>> isMember(
            @PathVariable String workspaceId, @RequestParam String email) {
        return userWorkspaceService
                .isMemberByEmail(workspaceId, email)
